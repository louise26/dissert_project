...
def get_policy(browser, url): 
    ...
    # href link contains the word privacy
    ...
    # <a> tag contains the word privacy (to use if privacy_button is empty)
    # privacy_tag = browser.find_elements_by_xpath("//a[contains('privacy')]")
